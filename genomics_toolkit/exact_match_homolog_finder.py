...
Note:
    ...
    v1.2.1: Corrected two stale references, after noticing the same
    issue in conserved_annotation_scanner.py. (1) The
    ...
    renamed to pairwise_homolog_finder.py (confirmed via that file's own
    docstring, which independently describes itself as the
    Smith-Waterman/BLOSUM62 sequence-based clustering tool); the rename
    was never propagated to this reference. (2) This file's own Example
    section instructed users to run
    ...
    v1.3.0: BREAKING CHANGE — while reasoning through whether this
